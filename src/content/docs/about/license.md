---
title: License
description: Evonic is open source under AGPL-3.0 with commercial license options.
---
...
The complete AGPL-3.0 license text is available in the project repository at [`LICENSE`](https://github.com/anvie/evonic/blob/main/LICENSE).
