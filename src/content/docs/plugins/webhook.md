...
| **Pull Request** | PR is opened, closed, etc. | ``, ``, ``, ``, ``, `` |
| **Issues** | Issue is opened, closed, etc. | ``, ``, ``, ``, ``, `` |
...
Each event group uses a **prompt template** that defines what the agent receives when a webhook fires. Templates use `` placeholders that are replaced with data from the webhook payload.
